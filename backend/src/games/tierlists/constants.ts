...
export const TIERLIST_ANIME_THEMES = [
  ...
  "Le meilleur combat",
  "Les plus sous-côtés",
  "À revoir encore une fois sans hésiter",
  "Recommandations à quelqu'un qui débute les animés",
  "Pour une soirée tranquille",
  "À regarder avec des amis",
  "Le meilleur potentiel de crossover",
  "Mérite une suite",
  "Mérite un spin-off",
  "Le plus de potentiel inexploité",
  "Le potentiel de mème",
  "Les animés avec le meilleur premier épisode",
  "Les animés avec la meilleure fin",
  "Les animés qui vieillissent le mieux",
  "Les animés que tu recommanderais à tout le monde",
  "Les animés les plus marquants",
  "Les animés qui méritent plus de reconnaissance",
] as const;

export const TIERLIST_CHARACTER_THEMES = [
  "Le meilleur protagoniste",
  "Le meilleur antagoniste",
  "Le meilleur deutéragoniste",
  ...
  "Le personnage le plus intelligent",
  "Le personnage le plus attachant",
  "Le personnage que tu voudrais comme ami",
  "Le personnage que tu voudrais comme voisin",
  "Le personnage avec le meilleur design",
  "Le personnage avec le meilleur développement",
  "Le personnage le plus sous-côté",
  "Le personnage le plus mémorable",
  "Le meilleur potentiel de mème",
...
export const TIERLIST_THEMES = [
  ...TIERLIST_ANIME_THEMES,
  ...TIERLIST_CHARACTER_THEMES,
] as const;
